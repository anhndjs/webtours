...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHJhbmR1Y2FhbmgiLCJhIjoiY2w4MWdnNnNyMGZzZjNxbzZuMjB5YW1ndiJ9.hrDoXacPpqm9YBfzGtSzVQ';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'login ok');
          ...
          case 9:
            ...
            (0, _alert.showAlert)('err', _context.t0.response.data.message);
